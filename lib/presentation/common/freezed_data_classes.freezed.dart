...
abstract class $RegisterObjectCopyWith<$Res> {
  ...
  @useResult
  $Res call({String userName, String phone, String email, String password});
}
...
class _$RegisterObjectImpl implements _RegisterObject {
  _$RegisterObjectImpl(this.userName, this.phone, this.email, this.password);
  ...
  @override
  String toString() {
    return 'RegisterObject(userName: $userName, phone: $phone, email: $email, password: $password)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, userName, phone, email, password);
...
abstract class _RegisterObject implements RegisterObject {
  factory _RegisterObject(final String userName, final String phone,
